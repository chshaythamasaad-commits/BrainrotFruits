...
local function buildIslandBase(map)
	...
	-- Keep overlapping island lobes on distinct top planes to avoid grass-on-grass z-fighting.
	BlockStyle.noteOffsetFix()
	createIslandPiece(island, "CoreGrass", Vector3.new(214, 0.7, 166), Vector3.new(0, -0.22, -8), COLORS.Grass)
	BlockStyle.noteOffsetFix()
	...
	BlockStyle.noteOffsetFix()
	createIslandPiece(island, "BackLobe", Vector3.new(196, 0.7, 82), Vector3.new(0, 0.06, -112), COLORS.Grass)
	BlockStyle.noteOffsetFix()
	createIslandPiece(island, "LaunchPeninsula", Vector3.new(88, 0.7, 260), Vector3.new(0, 0.0, 190), COLORS.Grass)
	BlockStyle.noteOffsetFix()
	createIslandPiece(island, "ExtendedLaunchCauseway", Vector3.new(76, 0.7, 330), Vector3.new(0, 0.14, 435), COLORS.GrassLight)
	BlockStyle.noteOffsetFix()
	createIslandPiece(island, "RevealPlatformIsland", Vector3.new(132, 0.7, 94), Vector3.new(0, 0.28, 628), COLORS.GrassDark)
...
function MapBuilder.build()
	...
	map:SetAttribute("StrawberitaPlatformAnimationVersion", "AliveIdle_V1")
	map:SetAttribute("StrawberitaIdleBehaviorVersion", "WaveHeadTurn_V1")
	map:SetAttribute("CharacterRosterVersion", "SixCharacterRoster_V1")
	map:SetAttribute("CharacterRegistryVersion", CharacterRegistry.Version)
	map:SetAttribute("CharacterModelFactoryVersion", CharacterModelFactory.Version)
	map:SetAttribute("BrainrotModelFactoryVersion", CharacterModelFactory.Version)
	map:SetAttribute("BrainrotShowcaseVisualVersion", "PremiumShowcaseMascots_V2")
	...
	map:SetAttribute("BrainrotAnimationServiceVersion", CharacterAnimationService.BrainrotVersion or CharacterAnimationService.Version)
	map:SetAttribute("CharacterIdleBehaviorVersion", CharacterAnimationService.IdleBehaviorVersion)
	map:SetAttribute("DisplayPresentationVersion", "AnimatedCollectibleDisplay_V1")
	map:SetAttribute("StrawberitaVariantVFXVersion", "VariantAuraSparkle_V1")
	map:SetAttribute("VisualCleanupVersion", "ZFightCleanup_Plots_V1")
	...
	print("[BrainrotFruits] BrainrotCharacterRegistry_V2 active")
	print("[BrainrotFruits] SixCharacterRoster_V1 active")
	print("[BrainrotFruits] BrainrotModelFactory_PremiumShowcaseMascots_V2 active")
	print("[BrainrotFruits] Premium character showroom visuals active")
	print("[BrainrotFruits] CharacterVariantService_V1 active")
	print("[BrainrotFruits] BrainrotAnimationService_V1 active")
	...
	print("[BrainrotFruits] ZFightCleanup_Plots_V1 active")
	print("[BrainrotFruits] Visible floor overlaps cleaned")
