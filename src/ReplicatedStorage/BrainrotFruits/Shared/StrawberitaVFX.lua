...
local VARIANT_CONFIGS = {
	Base = {
		...
		displayColor = Color3.fromRGB(255, 236, 244),
	...
	Golden = {
		...
		displayColor = Color3.fromRGB(255, 222, 84),
	...
	Rainbow = {
		displayName = "Rainbow Strawberita",
		auraColor = Color3.fromRGB(104, 238, 255),
		displayColor = Color3.fromRGB(255, 216, 91),
	...
	Toxic = {
		displayName = "Toxic Strawberita",
		auraColor = Color3.fromRGB(124, 255, 61),
		displayColor = Color3.fromRGB(196, 255, 90),
	...
	Cosmic = {
		displayName = "Cosmic Strawberita",
		auraColor = Color3.fromRGB(129, 81, 255),
		displayColor = Color3.fromRGB(145, 242, 255),
	...
	Diamond = {
		...
		displayColor = Color3.fromRGB(197, 250, 255),
	...
	Galaxy = {
		...
		platformDisplayLightBrightness = 0.42,
		platformLightRange = 10,
		trailRate = 18,
		trailIdleRate = 4,
		toolRate = 4,
...
function StrawberitaVFX.normalizeVariantName(value)
	...
	if string.find(lower, "gold") then
		return "Golden"
	elseif string.find(lower, "rainbow") or string.find(lower, "shiny") then
		return "Rainbow"
	elseif string.find(lower, "toxic") or string.find(lower, "slime") then
		return "Toxic"
