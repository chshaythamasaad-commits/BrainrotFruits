# Run Upgrades Stall Reference Notes

Use the images in this folder as the main visual/style reference for the Run Upgrades Stall.

Reference images:
- run_upgrades_front_left.png
- run_upgrades_front.png
- run_upgrades_front_right.png
- run_upgrades_rear_right.png

Goal:
- bright modern classic Roblox upgrades stall
- classic Roblox look modernized
- visible studs on major surfaces
- chunky block-built booth
- simple rectangular construction
- blue and white striped roof canopy
- tan/orange and brown stall body
- dark brown trim and base
- glowing blue interaction pad in front
...
2. Player should instantly see the glowing blue interaction pad / interaction area.
3. Player should instantly distinguish this stall from the sell stall, shop stall, index stand, or other booths.
4. Player should instantly recognize it as related to speed / run upgrades even if no text is visible in the mockup references.
...
- alternating blue and white roof stripes
- front glowing blue interaction pad
...
- use Neon only for the interaction pad glow if needed
...
Color direction:
- roof stripes: bright sky blue and white
- interaction pad: bright cyan / light blue
- optional glow/border: cyan neon
...
4. Is the blue/white roof stripe pattern clear?
5. Is the glowing blue interaction pad obvious?
